...
<head>
  ...
  <link rel="stylesheet" href="static/estiloPerfilLogin.css">
      ...
      <form method="POST" action="/Login">
        ...
        <div class="containerDaSenha">
          ...
          <div class="dentroSenha">
            ...
            <div id="icon" onclick="mostrar('senha','icon')"></div>
          </div>
        </div>

        <button type="submit" class="botao">Iniciar Sessão</button>

        <div class="cadastrar">
          <p>Não possui uma conta ainda?</p>
          <a href="/Cadastro">Criar uma conta.</a> <!--Leva para cadastro-->
        </div>
      </form>
    </section>
    <script src="/static/jsLogin.js"></script>
