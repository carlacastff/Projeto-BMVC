...
<section class="informaçõesPessoais">
    ...
    <div class="blocoPerfil">
        ...
        <div class="caixa"><input class="texto" type="text" placeholder="E-mail"></div>

        <div class="linhaDupla">
            <div class="caixaMetade1"><input class="texto" type="text" placeholder="Primeiro nome..."></div>
            <div class="caixaMetade2"><input class="texto" type="text" placeholder="Sobrenome..."></div>
        </div>
